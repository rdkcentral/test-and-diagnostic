...
**********************************************************************/
ANSC_STATUS Tad_GetParamValues(char *pchComponent, char *pchBus, char *pchParamName, ULONG64 *pulReturnVal)
{
    ...
    else if (CCSP_SUCCESS == iRet)
    {
        ...
        {
            *pulReturnVal = (ULONG64)strtoull(ppRetVal[0]->parameterValue, NULL, 10);
